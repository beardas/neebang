...
export default {
  ...
  async created() {
	...
	this.TopHeaderMenuForm[0].optionsClick = 0
	this.MapPoint = this.TopHeaderMenuForm[0].options[0].geoPoint
	this.MapLevel = this.TopHeaderMenuForm[0].options[0].level
  },
