...
export default {
  ...
  async created() {
	this.TopHeaderMenuForm[1].click = true
	this.TopHeaderMenuForm[1].optionsClick = 0
	this.MapPoint = this.TopHeaderMenuForm[1].options[0].geoPoint
	this.MapLevel = this.TopHeaderMenuForm[1].options[0].level
  },
