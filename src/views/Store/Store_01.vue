...
export default {
  ...
  async created() {
	this.TopHeaderMenuForm[4].click = true
	this.TopHeaderMenuForm[4].optionsClick = 0
	this.MapPoint = this.TopHeaderMenuForm[4].options[0].geoPoint
	this.MapLevel = this.TopHeaderMenuForm[4].options[0].level
  },
