...
export default {
  ...
  async created() {
	...
	this.TopHeaderMenuForm[0].optionsClick = 1
	this.MapPoint = this.TopHeaderMenuForm[0].options[1].geoPoint
	this.MapLevel = this.TopHeaderMenuForm[0].options[1].level
  },
