...
export default {
  ...
  async created() {
	this.TopHeaderMenuForm[2].click = true
	this.TopHeaderMenuForm[2].optionsClick = 0
	this.MapPoint = this.TopHeaderMenuForm[2].options[0].geoPoint
	this.MapLevel = this.TopHeaderMenuForm[2].options[0].level
  },
